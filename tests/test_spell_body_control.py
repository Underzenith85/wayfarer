...
from wayfarer.engine.rules.spell_body_control import BINDINGS, package
...
def test_exact_body_control_inventory_pages_and_runtime() -> None:
    ...
    assert all(value.evidence == ("tests/test_spell_body_control.py",) for value in rows.values())
