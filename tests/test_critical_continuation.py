...
from wayfarer.engine.simulation.mechanics.critical_continuation import Continuation
...
async def test_explicit_migration_resolves_original_wounds_once(
    ...
    import wayfarer.engine.simulation.mechanics.critical_limbs as limbs
