...
def test_mundane_skill_rows_carry_item_level_owners_and_certification_state() -> None:
    ...
    # #344 and #345: a bound procedure reaches certification as implemented, and
    # a transferred one reaches it naming the concrete open child that owns it.
    assert sum(r.implementation == "implemented" for r in rows) == 28
