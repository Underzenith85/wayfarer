...
| `gurps.combat.ranged_attack` | yes | yes | partial | #106; [ranged dispatch, rated bow/crossbow ST and evidence](gurps-ranged.md); #173 adds persisted critical misses, typed breakage, per-projectile locations, selected armed thrown-Parry modes, grounded critical drops, burst critical hits and [opt-in firearm malfunctions](gurps-firearms.md); #324 derives Basic range from authoritative facts; [remaining protocols](gurps-ranged.md) stay #173 |
...
state and receipt-idempotent transitions documented in
[`gurps-inventions.md`](gurps-inventions.md). Authored skill, complexity, novelty,
