...
| `gurps.combat.turn_timing` | yes | yes | partial | #104, #152, and #325; [actor-relative turns, overlapping subgroup clocks, Wait ordering, and decisive partial-cycle settlement](combat-timing.md); reinforcement timing remains #326 |
| `gurps.combat.ranged_attack` | yes | yes | partial | #106; [ranged dispatch, rated bow/crossbow ST and evidence](gurps-ranged.md); #173 adds persisted critical misses, typed breakage, per-projectile locations, selected armed thrown-Parry modes, grounded critical drops, burst critical hits and [opt-in firearm malfunctions](gurps-firearms.md); [remaining protocols](gurps-ranged.md) stay #173 |
