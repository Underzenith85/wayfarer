...
| `gurps.combat.turn_timing` | yes | yes | partial | #104, #152, #324, #325, and #326; [actor-relative turns, overlapping subgroup clocks, Wait ordering, Basic replay, decisive partial-cycle settlement](combat-timing.md), and [atomic reinforcement admission](combat-reinforcements.md) |
