...
| `gurps.combat.turn_timing` | yes | yes | partial | #104, #152, #324, and #325; [actor-relative turns, overlapping subgroup clocks, Wait ordering, Basic replay, and decisive partial-cycle settlement](combat-timing.md); reinforcement timing remains #326 |
