...
| `gurps.combat.turn_timing` | yes | yes | partial | #104, #152, #324, #325, #326, and #330; [actor-relative turns, overlapping subgroup clocks, Wait ordering, Basic replay, decisive partial-cycle settlement](combat-timing.md), [atomic reinforcement admission](combat-reinforcements.md), and [individual withdrawal](combat-withdrawal.md) |
