...
if TYPE_CHECKING:
    from wayfarer.orchestration.combat import ChooseDefense, MigrateEncounterHex
    from wayfarer.orchestration.play import PlayService
    from wayfarer.simulation.actions import PlayState


def migrate(play: PlayService, encounter: Encounter, command: MigrateEncounterHex) -> Encounter:
    if (
