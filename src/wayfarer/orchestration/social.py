...
from wayfarer.engine.rules.mundane_traits.runtime import Check
...
def bind_trait_modifiers(
    ...
    """
    from wayfarer.engine.character.social_traits import bind_standing, reaction_modifiers
...
def bind_skill_conditions(
    ...
    """
    from wayfarer.engine.rules.mundane_skills.social import Resolution, require_procedure
...
def dispatch(
    ...
    if command.kind == "fright":
        from wayfarer.engine.simulation.fright import validate_subject
    ...
    if command.kind == "fright":
        ...
        from wayfarer.engine.simulation.fright import apply_effect
