...
from wayfarer.engine.simulation.scenario_document import PublishedRevision
from wayfarer.engine.simulation.setup import CreateSetup, Seat, Setup, SetupCommand
...
def _activate_setup(
    ...
    _validate_setup(setup, play)
    if "scenario_document_json" in campaign:
        from wayfarer.engine.simulation.scenario_document import PregeneratedCharacter
...
def _lifecycle_setup(
    ...
    if op == "complete":
        ...
        from wayfarer.engine.simulation.continuation import AdventureSnapshot
