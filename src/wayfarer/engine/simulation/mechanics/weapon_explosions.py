...
from wayfarer.engine.rules.object_types import GroundPosition
from wayfarer.engine.simulation.actions import PlayState
from wayfarer.engine.simulation.combat import Battlefield, CombatEngine, Encounter, GridPoint
from wayfarer.engine.simulation.explosions import BlastRecord, blasts, save
...
def resolve_blast(
    ...
    *,
    ...
    from wayfarer.engine.simulation.hit_locations import select_location
    from wayfarer.engine.simulation.mechanics.gurps_melee import catalog, defense_value, movement
    from wayfarer.engine.simulation.mechanics.unarmed import hurt
    from wayfarer.engine.simulation.mechanics.weapon_flight import position
