...
def service(
    ...
    *,
    ...
    from wayfarer.engine.rules.skill_types import ControllingAttribute
    from wayfarer.engine.simulation.mechanics.gurps_melee import build, catalog, level
    ...
    unavailable = disabled(state, command.actor_id)
