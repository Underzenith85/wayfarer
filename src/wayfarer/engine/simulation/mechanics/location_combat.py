...
from wayfarer.engine.simulation.combat import Combatant, Encounter, Posture
from wayfarer.engine.simulation.gurps_equipment import MeleeMode, RangedMode
from wayfarer.engine.simulation.hit_locations import part, require_location, wound_factor
from wayfarer.engine.simulation.injury import ResolveCrippling, apply_injury
...
def validate_target(
    ...
    if location is not None:
        _validate_bindings(runtime, state, defender)
