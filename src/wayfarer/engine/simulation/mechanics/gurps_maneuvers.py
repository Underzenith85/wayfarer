...
from wayfarer.engine.simulation.mechanics.gurps_melee import build, catalog, level, mode
...
def observe(
    ...
    if command.maneuver == "aim":
        ...
        if aimed_mode.rated_strength is not None:
            ...
            from wayfarer.engine.simulation.mechanics.gurps_ranged import validate_rated_strength
