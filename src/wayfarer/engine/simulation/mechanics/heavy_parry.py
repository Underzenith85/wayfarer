...
from wayfarer.engine.simulation.combat import Combatant, Encounter
from wayfarer.engine.simulation.critical import Die
from wayfarer.engine.simulation.gurps_equipment import EquipmentProfile
...
def resolve_heavy_parry(
    ...
    from wayfarer.engine.simulation.mechanics.gurps_melee import heavy_parry_weight
    from wayfarer.engine.simulation.mechanics.object_combat import effective_entry, synchronize
