...
from wayfarer.engine.simulation.mechanics.recovery_guard import guard
from wayfarer.engine.simulation.mechanics.spell_bindings import SpellEnvironment
from wayfarer.engine.simulation.mechanics.spell_bindings import approved_context as build_context
...
def _release_missile(
    ...
    from wayfarer.engine.simulation.mechanics.gurps_melee import defense_value, injury_turn
