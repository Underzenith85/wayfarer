...
from wayfarer.engine.rules.hazard_types import HazardSchedule, HazardSpec, require_hazards_settled
...
from wayfarer.engine.rules.vehicle_types import VehicleTrace, WaterOccupantCheck
...
from wayfarer.engine.simulation.objects import DamageObject, StressObject, apply_object
from wayfarer.engine.simulation.resources import ResourceEngine, ResourceState
from wayfarer.engine.simulation.vehicle_collisions import (
    durability,
    impact,
    impact_actor,
    internal_id,
...
from wayfarer.engine.simulation.vehicle_motion import control_vehicle, footprint, move_vehicle
...
def resolve_vehicle(
    ...
    *,
    ...
    from wayfarer.engine.simulation.transport import validate_transport
