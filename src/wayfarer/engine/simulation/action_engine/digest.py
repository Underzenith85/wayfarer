...
def _configuration_digest(
    ...
    payload = (
        ...
        + (rules.economics.model_dump_json() if rules.economics else "")
        + (rules.development.model_dump_json() if rules.development else "")
        ...
        + (rules.artifacts.model_dump_json() if rules.artifacts else "")
