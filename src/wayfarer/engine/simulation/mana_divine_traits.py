...
from wayfarer.engine.character.mana_divine_traits import (
    MANA_LEVELS,
    ManaDivineTraits,
    mana_divine_traits,
)
from wayfarer.engine.rules.catalog import RuleDefinition
from wayfarer.engine.rules.magic_protocols import ManaLevel
from wayfarer.engine.simulation.resources import Command, ResourceEvent, ResourceState, Scheduled
from wayfarer.engine.simulation.spells import SpellContext
