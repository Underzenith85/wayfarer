...
from wayfarer.engine.rules.location_types import HitLocation, HumanLocation, LastingInjury
from wayfarer.engine.rules.recovery_types import interrupt_tasks, require_settled, retire_tasks
