...
from wayfarer.engine.rules.entangle_types import Entanglement
...
from wayfarer.engine.simulation.maneuvers import (
    ATTACK_MANEUVERS,
    AttackOption,
    DefenseOption,
    ManeuverState,
...
from wayfarer.engine.simulation.unarmed import Grip, PendingUnarmed, UnarmedTrace
...
class CombatEngine:
    ...
    def validate(
        ...
        if encounter.spatial_kind == "hex":
            from wayfarer.engine.simulation.tactical import validate_hex_encounter
        ...
        from wayfarer.engine.simulation.unarmed import validate_control
