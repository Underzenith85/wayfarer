...
from wayfarer.engine.rules.location_types import HitLocation
from wayfarer.engine.simulation.combat_height import HeightEffect, melee_height
...
if TYPE_CHECKING:
    from wayfarer.engine.simulation.combat import Combatant, Encounter, Maneuver
