...
from wayfarer.engine.rules.traits.physical import NO_PHYSICAL_TRAITS, PhysicalTraits, SurpriseState
from wayfarer.engine.rules.types.location import InjuryTolerance, LastingInjury
