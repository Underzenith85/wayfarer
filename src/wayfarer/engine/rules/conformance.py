...
_CAPABILITIES: Final = (
    ...
    Capability("gurps.skills.physical_outdoors", False, True, CoverageStatus.PARTIAL, 343),
    Capability("gurps.skills.technology_vehicles", False, True, CoverageStatus.PARTIAL, 346),
