...
_CAPABILITIES: Final = (
    ...
    Capability("gurps.injury.hit_locations", False, True, CoverageStatus.PARTIAL, 107),
    Capability("gurps.injury.armor_divisors", False, True, CoverageStatus.PARTIAL, 107),
