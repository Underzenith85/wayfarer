...
from wayfarer.engine.rules.location_types import InjuryTolerance, LastingInjury
from wayfarer.engine.rules.physical_traits import NO_PHYSICAL_TRAITS, PhysicalTraits, SurpriseState
