...
from wayfarer.character.mana_divine_traits import (
    MANA_LEVELS,
    ManaDivineTraits,
    mana_divine_traits,
)
...
from wayfarer.rules.magic_protocols import ManaLevel
from wayfarer.simulation.resources import Command, ResourceEvent, ResourceState, Scheduled
from wayfarer.simulation.spells import SpellContext
