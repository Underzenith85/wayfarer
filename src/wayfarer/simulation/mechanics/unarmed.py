...
from wayfarer.rules.checks import CheckTrace, Outcome, draw_dice
from wayfarer.rules.combat_tables import strong_damage_bonus
...
from wayfarer.simulation.mechanics.location_combat import disabled, unavailable_hand
...
def execute_unarmed(
    ...
    from wayfarer.simulation.combat_commands import ChooseDefense
...
def armor_dr(
    ...
    *,
    ...
    from wayfarer.simulation.hit_locations import armor_resistance
