...
from wayfarer.simulation.resources import AmmunitionLoad, ResourceEvent, ResourceState
...
def reload(
    ...
    *,
    ...
    from wayfarer.simulation.mechanics.gurps_ranged import validate_rated_strength
