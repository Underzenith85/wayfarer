...
from wayfarer.simulation.mechanics.spell_bindings import approved_context as build_context
...
def _release_missile(
    ...
    from wayfarer.simulation.mechanics.gurps_melee import defense_value, injury_turn
