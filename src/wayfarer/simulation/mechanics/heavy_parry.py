...
from wayfarer.rules.checks import draw_dice
...
def resolve_heavy_parry(
    ...
    from wayfarer.simulation.mechanics.gurps_melee import heavy_parry_weight
    from wayfarer.simulation.mechanics.object_combat import effective_entry, synchronize
