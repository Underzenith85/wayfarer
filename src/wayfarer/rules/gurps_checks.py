...
Every service here scores dice through :func:`wayfarer.rules.checks.evaluate_success`,
...
fails closed through :func:`wayfarer.rules.conformance.require_capabilities`.
...
from wayfarer.rules.conformance import BASELINE_ID, require_capabilities
